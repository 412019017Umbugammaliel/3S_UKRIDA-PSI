                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (isset($history['categoryPoints']) &&
                                            $history['categoryPoints']->isNotEmpty())
                                        ...
                                        <td class="align-middle">
                                            <button type="button" class="btn btn-primary btn-details"
                                                data-toggle="modal" data-target="#detailsModal{{ $loop->iteration }}"
                                    ...
                                    <div class="modal fade" id="detailsModal{{ $loop->iteration }}" tabindex="-1"
                                        role="dialog" aria-labelledby="detailsModalLabel{{ $loop->iteration }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="detailsModalLabel{{ $loop->iteration }}">Details</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @endphp
                                                    <h3 class="text-center mb-4 font-weight-bold text-warning">Hasil
                                                        Psikotes - Tes {{ $testNumber }}</h3>
                                                    <div class="card">
                                                        <div class="card-header bg-warning text-dark">
                                                            Perbandingan Hasil Psikotes
                                                        </div>
                                                        <div class="card-body">
                                                            <canvas id="comparisonChart-{{ $testNumber }}" width="400"
                                                                height="200"></canvas>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card mb-4">
                                                        ...
                                                        <div class="card-body">
                                                            @php
                                                            $categoryPoint = $categoryPoints->where('id_category',
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>{{ $classification->title }} - {{
                                                                        $classification->description }}</li>
                                                                    @endforeach
                                                                </ul>
                                                                @php
                                                                ...
                                                                @endphp
                                                                @else
                                                                <p class="text-danger">{{ __('No data available for this
                                                                    category in test number ' . $testNumber) }}</p>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <script>
                                                        document.addEventListener("DOMContentLoaded", function () {
                                                            var ctxComparison{{ $testNumber }
                                                        } = document.getElementById('comparisonChart-{{ $testNumber }}').getContext('2d');
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary"
                                                        onclick="printModal('{{ $loop->iteration }}')">Print Results
                                                        Tes</button>
                                                </div>
                                            </div>
                                        </div>
